...
const InputPassword = ({ formik }) => {
  ...
  return (
    <div className="flex flex-col mb-6 relative">
      ...
      <input
        className="rounded peer appearance-none bg-white border-2 border-gray-300 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-700 placeholder-transparent"
